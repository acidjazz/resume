...
export default {
  ...
  data () {
    return {
      skills: 'php javascript nodejs python git git-flow github github-actions laravel vapor passport socialite ux vuejs nuxtjs aws ec2 s3 lambda phpunit jest css html sass stylus pugjs pwa twa'
    }
  },
  computed: {
    skills_array () {
