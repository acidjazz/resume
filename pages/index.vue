<template lang="pug">
  .container.md
    ...
    PageSection(title="Profile")
      .text-lg Full stack and DevOps engineer looking to progress at a successful organization
    ...
    PageSection(title="Experience")
      ...
      BlockExperience(company="Foundstone / McAfee", title="Software Engineer", range="Oct 1999 - Aug 2003", location="Orange County, CA", link="https://mcaffee.com/")
        ul.list-disc.ml-8
      ...
      BlockExperience(company="Visual Perspectives", title="Software Engineer", range="Aug 1998 - Oct 1999", location="Orange County, CA", link="https://mcaffee.com/")
        ul.list-disc.ml-8
...
export default {
  ...
  data () {
    return {
      skills: 'php javascript nodejs python git git-flow github laravel ux vuejs nuxtjs aws ec2 s3 lambda phpunit jest css html sass stylus pugjs'
    }
  },
  computed: {
    skills_array () {
